...
export async function createEmployeesHandler(
  req: Request,
  res: Response,
): Promise<void> {
  ...
  try {
    const result: Employee | Prisma.BatchPayload = await createEmployee(
      employeeData,
    );
...
export async function updateEmployeesHandler(
  req: Request,
  res: Response,
): Promise<void> {
...
export async function deleteAllEmployeesHandler(
  _req: Request,
  res: Response,
): Promise<void> {
  try {
...
export async function getEmployeeByIdHandler(
  ...
  try {
    if (req.params.id) {
      const employee: Employee | null = await getEmployeeById(
