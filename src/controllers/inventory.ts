...
export async function createInventoryHandler(
  req: Request,
  res: Response,
): Promise<void> {
  const inventoryData: Inventory | Inventory[] = req.body;
  try {
    const result: Inventory | Prisma.BatchPayload = await createInventory(
      inventoryData,
    );
...
export async function updatesInventoryByIdHandler(
  req: Request,
  res: Response,
): Promise<void> {
...
export async function deleteInventoryByIdHandler(
  req: Request,
  res: Response,
): Promise<void> {
